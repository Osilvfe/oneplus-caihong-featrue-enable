...
MODDIR=${0%/*}
mount --bind $MODDIR/my_product/etc/permissions/oplus.feature.control_cn_gms.xml /my_bigball/etc/permissions/oplus.feature.control_cn_gms.xml #google share
mount --bind $MODDIR/my_product/etc/permissions/oplus_google_cn_gms_features.xml /my_bigball/etc/permissions/oplus_google_cn_gms_features.xml #google share
